  ...
  onLoad: function (e) {
    ...
    wx.getStorage({
      ...
      fail:function () {
        wx.setStorage({
            key: 'gourl',
            data: '/pages/product/buy?is_gift='+is_gift+'&from='+from+'&id='+e.id+'&gift_uid='+gift_uid+'&is_activity='+is_activity+'&activity_puid='+activity_puid+'&price='+e.price+'&gift_uid='+gift_uid
        })
