...
Page({
    ...
    toBaby:function () {
        if(this.data.info.baby_count == 0){
            //没有添加宝宝，跳到添加页面
            wx.navigateTo({
                url: '/pages/tabBar/my/babyinfo'
            })
        }else{
            //跳到宝宝列表页面
            wx.navigateTo({
                url: '/pages/tabBar/my/babylist'
            })
        }
    },
    ...
    toBindmobile:function () {
        wx.navigateTo({
            url: '/pages/tabBar/my/mobile_change'
        })
    },
