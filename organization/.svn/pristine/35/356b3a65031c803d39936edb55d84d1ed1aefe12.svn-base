...
Page({
  ...
  data: {
    ...
    tea_numIndex: 0,
    tea_numSelect: ["请选择教师人数", "3人以下", "3-5人", "5-10人", "10人以上"],  //教师人数
    agestrIndex:0,
    ...
    inhabitantIndex:0,
    inhabitantSelect: ["请选择合适人口范围", "5万人以下", "5-10万人", "10万人以上"], //常住人口
    //租赁期默认不显示
...
//修改选择器颜色
    typecolor: "#afb5ca",        //机构类型
    provincecolor: "#afb5ca",    //地区选择
    areacolor: "#afb5ca",        //机构面积
    sitecolor: "#afb5ca",        //场地类型
    invoicecolor: "#afb5ca",     //发票类型
    operateyearcolor: "#afb5ca", //经营年限
    educolor: "#afb5ca",         //教务
    teacolor: "#afb5ca",         //教师
    agecolor: "#afb5ca",         //年龄段
    studentscolor: "#afb5ca",    //人数
    classroomcolor: "#afb5ca",   //教室数量
    wallcolor: "#afb5ca",        //承重墙
    networkcolor: "#afb5ca",     //网络
    idlecolor: "#afb5ca",        //闲置

    //周边（颜色）
    transportcolor: "#afb5ca",    //交通状况
    infrascolor: "#afb5ca",       //基础设施
    communitycolor: "#afb5ca",    //社区
    inhabitcolor: "#afb5ca",      //常住人口

    similarcolor: "#afb5ca",       //同类机构
    kindergartencolor: "#afb5ca",  //幼儿园
  },
            ...
            */
            if (options.types == 'personal') {
              ...
              that.setData({
                ...
                tea_num: result.data.info.tea_num,
                ...
                tea_numIndex: result.data.info.tea_num ? that.findindexof(that.data.tea_numSelect, result.data.info.tea_num) : 0,
  ...
  */
  bindSitepropertiesChange: function (e) {
    ...
    if (site_propertiesName != "请选择场地性质") {
      this.setData({
        sitecolor: "#1e1d25"
      })
    } else {
  ...
  bindOperateyearChange: function (e) {
    ...
    if (operateyearName != "请选择经营年限") {
      this.setData({
        operateyearcolor: "#1e1d25"
      })
    } else {
      this.setData({
        operateyearcolor: "#afb5ca"
      })
    }
  },
...
请选择教师人数
*/
  bindTeaNumChange: function (e) {
    var tea_numIndex = e.detail.value;
    var tea_numName = this.data.operateyearSelect[tea_numIndex];
    this.setData({
      tea_numIndex: tea_numIndex,
      tea_numName: tea_numName
    })

    if (tea_numName != "请选择教务或市场人数") {
      this.setData({
        teacolor: "#1e1d25"
      })
    } else {
  ...
  */
  bindStudentsChange: function (e) {
    ...
    if (studentsName != "请选择学员人数") {
      this.setData({
        studentscolor: "#1e1d25"
      })
    } else {
      this.setData({
        studentscolor: "#afb5ca"
      })
    }
  },
  ...
  */
  bindClassRoomnumChange: function (e) {
    ...
    if (classroom_numName != "请选择教室数量") {
      this.setData({
        classroomcolor: "#1e1d25"
      })
    } else {
      this.setData({
        classroomcolor: "#afb5ca"
      })
    }
  },
   /*
  ...
  */
  bindIdletimeChange: function (e) {
    ...
    var idle_timeName = this.data.idle_timeSelect[idle_timeIndex];
    console.log(idle_timeName);
    this.setData({
      idle_timeIndex: idle_timeIndex,
      idle_timeName: idle_timeName
    })

    if (idle_timeName != "请选择教室闲置时间段") {
      this.setData({
        idlecolor: "#1e1d25"
      })
    } else {
  ...
  */
  bindTransportChange: function (e) {
    ...
    var transportName = this.data.transportSelect[transportIndex];
    this.setData({
    ...
    if (transportName != "请输入实际交通状况") {
      this.setData({
        transportcolor: "#1e1d25"
      })
    } else {
      this.setData({
        transportcolor: "#afb5ca"
      })
    }
  },
  /*
  ...
  */
  bindInfrastructureChange: function (e) {
    ...
    var infrastructureName = this.data.infrastructureSelect[infrastructureIndex];
    this.setData({
    ...
    if (infrastructureName != "请输入周边基础设施") {
      this.setData({
        infrascolor: "#1e1d25"
      })
    } else {
  ...
  bindCommunityChange: function (e) {
    ...
    var communityName = this.data.communitySelect[communityIndex];
    this.setData({
      communityIndex: communityIndex,
      //communityName: communityName
    })
    
    if (communityName != "请选择周边社区情况") {
      this.setData({
        communitycolor: "#1e1d25"
      })
    } else {
      this.setData({
        communitycolor: "#afb5ca"
      })
    }
  },
  ...
  */
  bindInhabitantChange: function (e) {
    ...
    var inhabitantName = this.data.inhabitantSelect[inhabitantIndex];
    this.setData({
  ...
  */
  ...
  formSubmit: function (e) {
    ...
    if (that.data.types == 'personal') {
      ...
      var tea_num = e.detail.value.tea_num //教师人数
      ...
      if (that.findindexof(that.data.tea_numSelect, tea_num) == '0') {
        wx.showModal({
          title: '请选择教师人数',
          showCancel: false,
        })
  ...
  backSave: function () {
    ...
    if (that.data.types == 'personal') {
      ...
      var tea_num = that.data.tea_num //教师人数
      //---------------------------
  ...
  get_Kindergarten: function (e) {
    var kindergartenvae = e.detail.value
    this.setData({
      kindergarten: e.detail.value
    })

    if (kindergartenvae != "0") {
      this.setData({
        kindergartencolor: "#1e1d25"
      })
    } else {
      this.setData({
        kindergartencolor: "#afb5ca"
      })
    }
  },
